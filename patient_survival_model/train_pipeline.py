...
from patient_survival_model.processing.data_manager import load_dataset, save_pipeline
...
def run_training() -> None:
    ...
    # Pipeline fitting
    patient_survival_pipe.fit(X_train,y_train)
    #y_pred = patient_survival_pipe.predict(X_test)
    #print("Accuracy(in %):", accuracy_score(y_test, y_pred)*100)

    # persist trained model
    save_pipeline(pipeline_to_persist= patient_survival_pipe)
    # printing the score
